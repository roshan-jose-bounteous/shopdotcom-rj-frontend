...
//   const { setSelectedSort } = useFilterStore();
...
const SortBySelect: React.FC = () => {
  const { selectedSort, setSelectedSort } = useFilterStore(); // Destructure selectedSort from the store
  ...
  return (
    <div className="flex flex-row items-center gap-2 font-albertsans">
      ...
      <div className="relative">
        <select
          value={selectedSort || "most-popular"} // Control the select value with Zustand state
          onChange={handleSortChange}
          className="text-black font-semibold bg-transparent border-none focus:outline-none"
        >
          <option value="most-popular">Most Popular</option>
